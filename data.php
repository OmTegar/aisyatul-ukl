...
<body>
                        ...
                        <div style="display: flex;">
                            <div class="brand">
                                <a href="index.html" style="text-decoration: none;">
                                    <h1><span>A</span>isyatul <span>H</span>uriyah</h1>
                                </a>
                            </div>
                            ...
                            <div style="width: 50%; text-align: right;">
                                <button type="button" class="btn text-light bg-blue" data-bs-toggle="modal"
                                    ...
                                    style="background-color: #FFC0CB; color: #fff; padding: 10px; text-decoration: none; font-size: 12px; border: 0px; margin-top: 20px;">+Add
                                    Data</button>
                            </div>
                        </div>
                        <!-- Add Modal -->
    ...
    <div class="row my-3">
        ...
        <div class="col">
            <!-- Add Button -->
            <button type="button" class="btn text-light bg-blue" data-toggle="modal" data-target="#addContact">+ Add
                Data</button>
            <!-- Add Modal -->
                            ...
                            <form method="post" action="../controller/proses_simpan.php" enctype="multipart/form-data">
                                <section class="base">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="absen" name="absen" class="form-control" autofocus
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label>Kelas</label>
